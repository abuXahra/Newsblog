...
const Postcard = ({ pl, pb, w, imgUrl, content, size, text, linkColor, headingColor, iconColor, linkUrl, editIcon, postAuthor, dateIcon, dateText, commentIcon, commentCounter, linkDisplay, editIconDisplay, postUrl }) => {
